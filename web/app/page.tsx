	...
	return (
		<div className="flex flex-1 flex-col items-center justify-center bg-zinc-50 px-6 font-sans dark:bg-black">
			<main className="flex max-w-xl flex-col items-center gap-6 text-center">
				...
				<h1 className="text-4xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">ClearContract</h1>
				<p className="text-lg leading-8 text-zinc-600 dark:text-zinc-400">
					Professional quotes and invoices for independent contractors. Send a quote by email, let your
					customer accept and pay a deposit online, and stop chasing.
				</p>
